$(document).ready(function(){ 
    ...
    function showChart(){
        ...
        changeChart(chart, fiscalia, start_date, finish_date);
        setTable(chart, fiscalia, start_date, finish_date);
    ...
    $('#search-chart-btn').on('click', function() {
		$("#chart-container").load('../views/genetic/charts/bars_chart.php',
            {'id': this.id, 'url':'<?=$url?>'});
		return false;
    });
    ...
    function changeChart(type, fiscalia, start_date, finish_date){
        ...
        switch(type){
            case '0':
                $.ajax({  
                    type: "POST",  
                    url: "../views/genetic/charts/service/get_count_records_by_month.php", 
                    ...
                    success: function(response){
                        ...
                        $.ajax({  
                            type: "POST",  
                            url: "../views/genetic/charts/service/get_count_studies_by_month.php", 
                            data: "fiscalia="+fiscalia+
                                "&start_date="+start_date+
                                "&finish_date="+finish_date,
                            success: function(response){
                                ...
                                $("#chart-container").load('../views/genetic/charts/templates/charts/bars_charts.php',
            ...
            case '1':
                ...
                $.ajax({  
                    type: "POST",  
                    url: "../views/genetic/charts/service/get_count_studies_by_type.php", 
                    data: "fiscalia="+fiscalia+
                        "&start_date="+start_date+
                        "&finish_date="+finish_date,
                    success: function(response){
                        ...
                        $("#chart-container").load('../views/genetic/charts/templates/charts/stacked_bars_charts.php',
                    ...
                    success: function(response){
                        ...
                        $.ajax({  
                            ...
                            success: function(response){
                                ...
                                $("#chart-container").load('../views/genetic/charts/templates/charts/line_charts.php',
                                    {'x1': content_records.x, 'y1': content_records.y, 'x2': content_details.x, 'y2': content_details.y});
            ...
            case '3':
                $.ajax({  
                    type: "POST",  
                    url: "../views/genetic/charts/service/get_count_records_by_region.php", 
                    data: "fiscalia="+fiscalia+
                          "&start_date="+start_date+
                          "&finish_date="+finish_date,
                    success: function(response){
                        ...
                        $.ajax({  
                            type: "POST",  
                            url: "../views/genetic/charts/service/get_count_studies_by_region.php", 
                            data: "fiscalia="+fiscalia+
                                "&start_date="+start_date+
                                "&finish_date="+finish_date,
                            success: function(response){
    ...
    function setTable(type, fiscalia, start_date, finish_date){
        ...
        switch(type){
            ...
            case '0':
                ...
                $.ajax({  
                    type: "POST",  
                    url: "../views/genetic/charts/templates/tables/records_studies_by_month.php", 
                    data: "fiscalia="+fiscalia+
                        "&start_date="+start_date+
                        "&finish_date="+finish_date,
                    success: function(response){
            ...
            case '1':
                ...
                $.ajax({  
                    type: "POST",  
                    url: "../views/genetic/charts/templates/tables/studies_by_type.php", 
                    data: "fiscalia="+fiscalia+
                        "&start_date="+start_date+
                        "&finish_date="+finish_date,
                    success: function(response){
            ...
            case '2':
                ...
                $.ajax({  
                    type: "POST",  
                    url: "../views/genetic/charts/templates/tables/records_by_month.php", 
                    data: "fiscalia="+fiscalia+
                        "&start_date="+start_date+
                        "&finish_date="+finish_date,
                    success: function(response){
            ...
            case '3':
                ...
                $.ajax({  
                    type: "POST",  
                    url: "../views/genetic/charts/templates/tables/records_studies_by_region.php", 
                    data: "fiscalia="+fiscalia+
                        "&start_date="+start_date+
                        "&finish_date="+finish_date,
                    success: function(response){
