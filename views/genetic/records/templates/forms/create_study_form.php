...
<form action="" class="form-group" id="create_study_form">
    ...
    <div class="button-form">
        ...
        <button type="button" class="btn btn-outline-primary" onclick="createStudy(<?php echo $record_id; ?>, 'create')" id="add-study-btn" style="display: none;">Agregar estudio</button>
    </div>
